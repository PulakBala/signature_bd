...
const BioDegradableDetails = () => {
    const sections = [
        ...
        {
            title: "Inspiring Eco-Friendly Choices",
            text: (
                <>
                    🌿 Eco-friendly Choices for a Brighter Tomorrow<br />
                    🌎 Green Choices for a Cleaner Planet<br />
                    🛠️ Sustainably Made, Expertly Crafted<br />
                    🍃 Nature Knows Best: Choose Biodegradable<br />
                    ✨ Join the Movement: Go Green, Go Biodegradable<br />
                    💚 Goodbye Plastic, Hello Planet!<br />
                    🌱 Earth-Friendly Solutions for Everyday Use<br />
                    🌍 From Nature, For Nature: Biodegradable Goods<br />
                    🌟 Every Purchase is a Vote for a Healthy Planet
                </>
            ),
            imgSrc: "/biooo.png",
            imgAlt: "Bio Product Life-Cycle"
            ...
            <section className="hero-section">
                <div className="container py-5">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-12">
                            <h1 className="display-4 text-success font-weight-bold text-center text-lg-left text-uppercase">
